    ...
    return (
      <View style={this.props.styles.container}>
        ...
        <View style={this.props.styles.right}>
          <Themes nextScene={this.props.nextScene} currentOption={this.state.currentOption}></Themes>
        </View>
      </View>
    );
  }
        ...
        content = (
          <View style={ThemesStyle.container}>
            <View style={ThemesStyle.row}>
              <TouchableWithoutFeedback onPress={() => this.props.nextScene('1')} >
              ...
              <TouchableWithoutFeedback onPress={() => this.props.nextScene('2')} >
            ...
            <View style={ThemesStyle.row}>
              <TouchableWithoutFeedback onPress={() => this.props.nextScene('3')} >
                <View style={ThemesStyle.box2}>
                  <Image
                    source={require('./../assets/icons/Like.png')}
                    style={{height: 28, width: 28, marginRight: 13, alignSelf: 'flex-end'}}
              ...
              <TouchableWithoutFeedback onPress={() => this.props.nextScene('4')} >
                <View style={ThemesStyle.box1}>
                  <Image
                    source={require('./../assets/icons/Like.png')}
                    style={{height: 28, width: 28, marginRight: 13, alignSelf: 'flex-end'}}
